        ...
        <header className="page-header">
            <div className="services">
                <div className="services-content">
                    <a className="location" href="#">Сочи</a>
                    ...
                    <ul className="fonts">
                        <li>
                            <button className="font-button-sans-serif active" type="button">А</button>
                        </li>
                        <li>
                            <button className="font-button-serif" type="button">А</button>
                        </li>
                    </ul>
                </div>
            </div>
            <nav className="main-nav">
                <p className="logo">
                    <img src={logo} width="64" height="68" alt="Логотип яхт-клуба Yacht Club" />
                </p>
