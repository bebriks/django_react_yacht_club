...
export const News = () => {
    ...
    <article class="post">
      <figure class="post-img">
        <img src={news_photo} width="770" height="301" alt="Человек в форме моряка на морском судне"/>
      ...
      <footer class="post-footer">
        <img class="post-author-img" src={author} width="60" height="60" alt="Артем Колесников"/>
        <p class="post-meta">
